      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="bg-card p-6 rounded-2xl shadow-soft border border-border/50 hover:shadow-elegant transition-all duration-300 hover:-translate-y-1"
            >
        ...
        <div className="text-center mt-10">
          <p className="text-muted-foreground">
            ⭐ Mais de <span className="font-bold text-primary">2.847 alunas</span> satisfeitas
          </p>
        </div>
      </div>
    </section>
