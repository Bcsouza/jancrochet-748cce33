  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-20 text-center animate-fade-up">
        <div className="mb-8">
          <span className="inline-block px-6 py-2 bg-accent/30 backdrop-blur-sm rounded-full text-sm font-montserrat font-medium text-foreground mb-6 animate-fade-in">
            ✨ Em breve
          </span>
        ...
        <Button 
          onClick={scrollToCTA}
          size="lg"
          className="font-montserrat font-semibold text-lg px-10 py-7 rounded-full bg-primary hover:bg-primary/90 text-primary-foreground shadow-soft hover:shadow-hover transition-all duration-300 hover:scale-105 animate-scale-in animation-delay-400"
        >
          Eu quero isso! 🧶
        </Button>
      </div>
